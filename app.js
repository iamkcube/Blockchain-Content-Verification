...
app.get("/modification_reciept", (req, res) =>
    {
        res.render('modification_reciept');
    });
...
app.post('/modify', async (req, res) =>
{
    try
    {
        ...
        console.log('Land Record modified successfully!');
        ...
        res.status(200).render('modification_reciept', { newHashKey, username, timestamp });
    } catch (error)
    {
